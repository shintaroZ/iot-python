...
class LambdaFunctionTest(unittest.TestCase):
    ...
    def test_lambda_handler_006(self):
        ...
        RDS.execute(initCommon.getQuery("test/sql/t_score/upsert101.sql"))
    
        # マスタメンテ
        RDS.execute(initCommon.getQuery("test/sql/mastermainte/limitCheckUpsert_7_001.sql"))
        RDS.execute(initCommon.getQuery("test/sql/mastermainte/limitUpsert_7_001.sql"))
        RDS.execute(initCommon.getQuery("test/sql/mastermainte/mailSendUpsert001.sql"))
